...
const ShortBio = () => (
  <article className="flex flex-col lg:flex-row md:justify-center md:items-center my-10 lg:my-4 space-y-10">
    ...
    <p className="p-7 2xl:p-48 md:w-3/5 md:px-20 text-3xl text-justify leading-relaxed 2xl:leading-loose">
      ...
      <br />
      <br />
      It thrills me to experiment with new technologies, build small projects,
      or tinker with vanilla Javascript. When I&apos;m not at my computer, you can
      find me reading a book, listening to podcasts, or traveling.
    </p>
  </article>
);
