      ...
      <div className="h-full flex flex-col justify-between space-y-3 bg-concrete bg-cream py-4 px-2 md:p-6 shadow-sm md:shadow-md">
        <div className="flex justify-center sm:pt-10 space-x-4">
          <a
            ...
            rel="noreferrer"
          >
            <button type="button" className={ buttonStyle }>Go To Project</button>
          </a>
          <a
            href={ work.github }
            target="_blank"
            ...
            rel="noreferrer"
          >
            <button type="button" className={ buttonStyle }>View Raw Code</button>
          </a>
        </div>
...
FlipCards.propTypes = {
  ...
  skillMapper: PropTypes.func.isRequired,
