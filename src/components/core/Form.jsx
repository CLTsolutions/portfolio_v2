...
const Form = ({
  ...
  const input = 'w-full text-2xl p-4 rounded-lg outline-none border-2 border-transparent focus:border-rose-300';
  const errInput = 'w-full text-2xl p-4 rounded-lg outline-none border-2 border-red-500 focus:border-rose-300';
...
Form.propTypes = {
  ...
  renderFieldError: PropTypes.func.isRequired,
